...
public class MappingMissingPerson extends ActionBarActivity {

    public final String AB_URL = "https://searchbertha-hrd.appspot.com/_ah/api/search/v1/zipcodes/10101/programs?api_key=b0f6c6a6a8be355fc04be76ab3f0c5e6&serviceTag=help%20find%20missing%20persons";
    ViewPager viewPager;
    MapFragment mapFragment;
    MapListFragment mapListFragment;
    List<Program> programs;
    HashMap<String,List<Program>> missingPerson;
